...
dict = arff.load(open('../Datasets/Classification/tvs_loan_default.arff'))
...
df.columns = title
df.drop(df.loc[85048:].index, inplace=True)
...
thisFile = "tvs_loan_default_GBDT"
